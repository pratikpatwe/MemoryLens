    ...
    <footer className="bg-slate-100 border-t border-slate-200">
      <div className="container mx-auto max-w-6xl px-4 md:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <ScanEye className="h-6 w-6 text-slate-900" />
              <span className="font-bold text-lg text-slate-900">MemoryLens</span>
            </Link>
            <p className="text-slate-600 mb-4 max-w-md">
              Helping people with memory-related challenges stay connected to their experiences through innovative IoT
              technology.
            </p>
        ...
        <div className="border-t border-slate-200 mt-12 pt-8 text-center text-slate-600 text-sm">
          <p>&copy; {new Date().getFullYear()} MemoryLens. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
